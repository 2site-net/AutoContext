...
public sealed class InstructionsManifestBuilderTests
{
    public sealed class Build(TempDirectoryFixture tempDirectory) : IClassFixture<TempDirectoryFixture>
    {
        ...
        [Fact]
        public async Task Should_build_one_entry_per_corpus_file()
        {
            // Arrange
            ...
            // Act
            var manifest = _sut.Build(await _corpusParser.ParseAsync(corpus, TestContext.Current.CancellationToken));
        ...
        [Fact]
        public async Task Should_order_entries_by_key()
        {
            // Arrange
            var corpus = tempDirectory.CreateDirectory();
        ...
        [Fact]
        public async Task Should_extract_key_and_version_from_name()
        {
            // Arrange
            var corpus = tempDirectory.CreateDirectory();
            ...
            // Act
            var entry = _sut.Build(await _corpusParser.ParseAsync(corpus, TestContext.Current.CancellationToken)).Instructions.Single();
        ...
        [Fact]
        public async Task Should_carry_verbatim_apply_to()
        {
            // Arrange
            var corpus = tempDirectory.CreateDirectory();
        ...
        [Fact]
        public async Task Should_omit_apply_to_when_absent()
        {
            // Arrange
            var corpus = tempDirectory.CreateDirectory();
        ...
        [Fact]
        public async Task Should_detect_sibling_changelog()
        {
            // Arrange
            var corpus = tempDirectory.CreateDirectory();
            InstructionsCorpusTestWriter.WriteInstruction(corpus, "code-review.instructions.md", "code-review (v1.0.0)", "Review.");
        ...
        [Fact]
        public async Task Should_hash_body_with_sha256_prefix()
        {
            // Arrange
            var corpus = tempDirectory.CreateDirectory();
            InstructionsCorpusTestWriter.WriteInstruction(corpus, "code-review.instructions.md", "code-review (v1.0.0)", "Review.");
        ...
        [Fact]
        public async Task Should_extract_section_index_from_body()
        {
            // Arrange
            var corpus = tempDirectory.CreateDirectory();
            ...
            // Act
            var sections = _sut.Build(await _corpusParser.ParseAsync(corpus, TestContext.Current.CancellationToken)).Instructions.Single().Sections;
        ...
        [Fact]
        public async Task Should_yield_empty_sections_when_body_has_no_headings()
        {
            // Arrange
            var corpus = tempDirectory.CreateDirectory();
            InstructionsCorpusTestWriter.WriteInstruction(
        ...
        [Fact]
        public async Task Should_derive_sorted_extension_set_from_apply_to()
        {
            // Arrange
            var corpus = tempDirectory.CreateDirectory();
            InstructionsCorpusTestWriter.WriteInstruction(
        ...
        [Fact]
        public async Task Should_yield_null_extensions_when_apply_to_absent()
        {
            // Arrange
            var corpus = tempDirectory.CreateDirectory();
            InstructionsCorpusTestWriter.WriteInstruction(
        ...
        [Fact]
        public async Task Should_yield_empty_extensions_when_apply_to_names_no_extension()
        {
            // Arrange
            var corpus = tempDirectory.CreateDirectory();
            InstructionsCorpusTestWriter.WriteInstruction(
        ...
        [Fact]
        public async Task Should_throw_when_name_is_missing()
        {
            // Arrange
            var corpus = tempDirectory.CreateDirectory();
            await File.WriteAllTextAsync(
                Path.Combine(corpus, "broken.instructions.md"),
                "---\ndescription: \"No name.\"\n---\nBody.\n",
                TestContext.Current.CancellationToken);
            var parsed = await _corpusParser.ParseAsync(corpus, TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task Should_throw_when_key_does_not_match_file_name()
        {
            // Arrange
            var corpus = tempDirectory.CreateDirectory();
        ...
        [Fact]
        public async Task Should_throw_on_duplicate_section_anchor()
        {
            // Arrange
            var corpus = tempDirectory.CreateDirectory();
            InstructionsCorpusTestWriter.WriteInstruction(
