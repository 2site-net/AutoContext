...
public sealed class ToolsStatusConfigTests : IDisposable
{
    ...
    {
        // Act
        var result = ToolsStatusConfig.IsEnabled("check_code_style");
    ...
    {
        // Arrange
        File.WriteAllText(StatusFilePath, """{ "check_code_style": true }""");
    ...
    {
        // Arrange
        File.WriteAllText(StatusFilePath, """{ "check_code_style": false }""");
