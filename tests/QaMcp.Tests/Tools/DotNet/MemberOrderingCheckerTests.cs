...
public sealed class MemberOrderingCheckerTests
{
    [Fact]
    public void Should_pass_correctly_ordered_members()
    {
        ...
        // Act
        var result = new MemberOrderingChecker().Check(source);
    ...
    {
        // Act & Assert
        Assert.Throws<ArgumentException>(() => new MemberOrderingChecker().Check(input));
    }
    ...
    {
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() => new MemberOrderingChecker().Check(null!));
    }
