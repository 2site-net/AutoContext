...
public sealed class NamingConventionsCheckerTests
{
    [Fact]
    public void Should_pass_well_named_code()
    {
        ...
        // Act
        var result = new NamingConventionsChecker().Check(source);
    ...
    {
        // Act & Assert
        Assert.Throws<ArgumentException>(() => new NamingConventionsChecker().Check(input));
    }
    ...
    {
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() => new NamingConventionsChecker().Check(null!));
    }
