...
`ExtensionActivator.run()` runs the async startup work in five sub-phases. Phases are sequential when there is a true ordering dependency, parallel within a phase otherwise.
