...
/// constructs <see cref="JsonLifecycleEvent"/> values for transitions
...
internal sealed class LifecycleNotifier
{
    ...
    /// <see cref="JsonLifecycleEvent.InstanceId"/> onto every published
    /// event.</param>
    ...
    {
        return _events.TryComplete(new JsonLifecycleEvent
        {
