...
/// <c>.autocontext.json</c>, holding one instructions file's state. The
...
/// </summary>
/// <param name="Version">The MAJOR.MINOR instructions-file version the
...
/// instructions file is disabled. Only ever <see langword="true"/>
