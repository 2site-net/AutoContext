...
- [INST0009] **Do** place reusable test-support code that belongs to a single test project inside a `Support/` folder at the test-project root, mirroring the production project's feature/domain structure. Cross-cutting helpers go under `Support/Shared/` per the principle in [testing#INST0015].
