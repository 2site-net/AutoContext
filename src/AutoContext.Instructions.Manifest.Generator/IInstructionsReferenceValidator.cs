...
/// a whole-corpus catalogue and aggregates the faults. This is the build-time driver
/// for the pure <see cref="InstructionsFileReferenceResolver"/>:
/// it projects the parsed corpus into a catalogue once, then resolves each file's
...
{
    /// <summary>
    /// Resolves every reference in <paramref name="corpus"/> against the catalogue
