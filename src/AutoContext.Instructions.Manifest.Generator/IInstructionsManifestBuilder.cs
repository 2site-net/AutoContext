...
/// already-parsed curated corpus. In a single pass it validates each file's
/// curatorial frontmatter shape (name, key, description, <c>applyTo</c>) and
/// extracts its derived facts (section map, <c>applyTo</c> extension set, content
/// hash, changelog flag).
/// </summary>
