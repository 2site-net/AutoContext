...
{
    /// <summary>
    /// The MCP tool name used for toggle lookup in <c>.autocontext.json</c>.
    /// </summary>
    string ToolName { get; }
    ...
    /// </summary>
    Task<string> CheckAsync(string content, IReadOnlyDictionary<string, string>? data = null, CancellationToken ct = default);
}
