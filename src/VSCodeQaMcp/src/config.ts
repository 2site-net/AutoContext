...
export const tools: readonly ToolEntry[] = [
    ...
    { settingId: 'qa-mcp.tools.check_coding_style', toolName: 'check_coding_style', label: 'Coding Style', category: '.NET Tool' },
    ...
    { settingId: 'qa-mcp.tools.check_commit_content', toolName: 'check_commit_content', label: 'Commit Content', category: 'Git Tool' },
    { settingId: 'qa-mcp.tools.check_commit_format', toolName: 'check_commit_format', label: 'Commit Format', category: 'Git Tool' },
];
