...
description: "Apply when writing or reviewing Kotlin code (naming, null safety, type design, scope functions, collections, coroutines)."
applyTo: "**/*.{kt,kts}"
---

# Kotlin Coding Instructions
