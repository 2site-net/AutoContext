...
- **Server Health Monitoring** — The MCP server and its workers report their liveness via a named-pipe health protocol. The MCP Tools panel shows live status indicators and offers inline Start, Stop, Restart, and Show Output actions for direct server management.
