namespace AutoContext.WorkspaceServer.Tests.Features.EditorConfig;
...
public sealed class EditorConfigResolverTests : IDisposable
{
    ...
    [Fact]
    public void Should_filter_by_keys_when_provided()
    {
        File.WriteAllText(
            Path.Combine(_tempRoot, ".editorconfig"),
            """
    ...
    [Fact]
    public void Should_return_all_when_keys_is_null()
    {
        File.WriteAllText(
            Path.Combine(_tempRoot, ".editorconfig"),
            """
    ...
    [Fact]
    public void Should_return_all_when_keys_is_empty()
    {
        File.WriteAllText(
            Path.Combine(_tempRoot, ".editorconfig"),
            """
