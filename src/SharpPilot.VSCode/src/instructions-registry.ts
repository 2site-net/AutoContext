...
export class InstructionsRegistry {
    ...
    static get all(): readonly InstructionsCatalogEntry[] {
    ...
    static findByFileName(fileName: string): InstructionsCatalogEntry | undefined {
        return this.catalog.findByFileName(fileName);
    }
}
