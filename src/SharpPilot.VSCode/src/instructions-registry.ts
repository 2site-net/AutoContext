...
export class InstructionsRegistry {
    private static readonly catalog = new InstructionsCatalog([
        ...
        { settingId: 'sharppilot.instructions.dotnet.csharp', fileName: 'dotnet-csharp.instructions.md', label: 'C#', category: '.NET', contextKeys: ['hasCSharp'] },
        ...
        { settingId: 'sharppilot.instructions.jvm.java', fileName: 'jvm-java.instructions.md', label: 'Java', category: 'JVM', contextKeys: ['hasJava'] },
        { settingId: 'sharppilot.instructions.jvm.kotlin', fileName: 'jvm-kotlin.instructions.md', label: 'Kotlin', category: 'JVM', contextKeys: ['hasKotlin'] },
        { settingId: 'sharppilot.instructions.jvm.scala', fileName: 'jvm-scala.instructions.md', label: 'Scala', category: 'JVM', contextKeys: ['hasScala'] },
        { settingId: 'sharppilot.instructions.jvm.groovy', fileName: 'jvm-groovy.instructions.md', label: 'Groovy', category: 'JVM', contextKeys: ['hasGroovy'] },
        ...
        { settingId: 'sharppilot.instructions.web.php', fileName: 'web-php.instructions.md', label: 'PHP', category: 'Web', contextKeys: ['hasPhp'] },
