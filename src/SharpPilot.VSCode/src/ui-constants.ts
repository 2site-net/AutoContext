...
export const mcpTools: readonly McpToolEntry[] = [
    ...
    { settingId: 'sharppilot.tools.check_csharp_naming_conventions', featureName: 'check_csharp_naming_conventions', toolName: 'check_csharp_all', label: 'Naming Conventions', category: 'C#', group: '.NET', serverCategory: 'dotnet', contextKeys: ['hasCSharp'] },
    { settingId: 'sharppilot.tools.check_csharp_nullable_context', featureName: 'check_csharp_nullable_context', toolName: 'check_csharp_all', label: 'Nullable Context', category: 'C#', group: '.NET', serverCategory: 'dotnet', contextKeys: ['hasCSharp'] },
    { settingId: 'sharppilot.tools.check_csharp_project_structure', featureName: 'check_csharp_project_structure', toolName: 'check_csharp_all', label: 'Project Structure', category: 'C#', group: '.NET', serverCategory: 'dotnet', contextKeys: ['hasCSharp'] },
    { settingId: 'sharppilot.tools.check_csharp_test_style', featureName: 'check_csharp_test_style', toolName: 'check_csharp_all', label: 'Test Style', category: 'C#', group: '.NET', serverCategory: 'dotnet', contextKeys: ['hasCSharp'] },
    { settingId: 'sharppilot.tools.check_nuget_hygiene', toolName: 'check_nuget_hygiene', label: 'NuGet Hygiene', category: 'NuGet', group: '.NET', serverCategory: 'dotnet', contextKeys: ['hasDotNet'] },
    { settingId: 'sharppilot.tools.check_git_commit_content', featureName: 'check_git_commit_content', toolName: 'check_git_all', label: 'Commit Content', category: 'Git', group: 'Workspace', serverCategory: 'git', contextKeys: ['hasGit'] },
    { settingId: 'sharppilot.tools.check_git_commit_format', featureName: 'check_git_commit_format', toolName: 'check_git_all', label: 'Commit Format', category: 'Git', group: 'Workspace', serverCategory: 'git', contextKeys: ['hasGit'] },
    { settingId: 'sharppilot.tools.get_editorconfig', toolName: 'get_editorconfig', label: 'EditorConfig', category: 'EditorConfig', group: 'Workspace', serverCategory: 'editorconfig' },
    { settingId: 'sharppilot.tools.check_typescript_coding_style', featureName: 'check_typescript_coding_style', toolName: 'check_typescript_all', label: 'Coding Style', category: 'TypeScript', group: 'Web', serverCategory: 'typescript', contextKeys: ['hasTypeScript'] },
];
