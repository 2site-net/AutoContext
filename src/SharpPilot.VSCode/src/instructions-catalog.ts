...
export const instructions: readonly InstructionEntry[] = [
    ...
    { settingId: 'sharppilot.instructions.dotnet.testing', fileName: 'dotnet-testing.instructions.md', label: 'Testing', category: '.NET', contextKeys: ['hasDotnet'] },
    ...
    { settingId: 'sharppilot.instructions.dotnet.csharp.codingStyle', fileName: 'dotnet-csharp.instructions.md', label: 'C#', category: '.NET', contextKeys: ['hasDotnet'] },
