...
- **57 Chat Instructions** — Markdown guidelines covering .NET, C#, F#, VB.NET, TypeScript, testing frameworks, Git, REST APIs, and more. Active instructions are automatically attached to every Copilot Chat conversation so Copilot follows your coding standards without being told each time.
