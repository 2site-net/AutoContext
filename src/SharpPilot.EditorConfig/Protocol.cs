...
/// <summary>
/// JSON-serializable request sent to the EditorConfig service over the named pipe.
/// </summary>
...
/// <summary>
/// JSON-serializable response returned by the EditorConfig service over the named pipe.
/// </summary>
