...
public sealed class AnalyzeGitCommitContentTaskTests
{
    ...
    {
        // Arrange
        var sut = new AnalyzeGitCommitContentTask();

        // Act
        var output = await McpTaskRunner.RunAsync(sut, new { content = "feat: add login" });
...
public sealed class AnalyzeGitCommitContentTaskTests
{
    ...
    {
        // Act
        var output = await ExecuteAsync("feat: add login");
    ...
    {
        // Arrange
        var task = new AnalyzeGitCommitContentTask();
