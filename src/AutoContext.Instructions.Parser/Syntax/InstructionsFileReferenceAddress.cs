...
/// target. The span parser works this out once for each well-formed reference and
/// attaches it to the reference span; the structured parser reads it back and adds
/// the body-relative position, which only it can work out. When this is
