...
/// <see cref="Model.InstructionsFile.FromSyntaxTree"/> later sets <see cref="Line"/> to
...
/// <see cref="Model.InstructionsFile.FromSyntaxTree"/> fills it in from the owning span's
