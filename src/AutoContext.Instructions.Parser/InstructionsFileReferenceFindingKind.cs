...
/// the corpus catalogue. Unlike <see cref="InstructionsFileDiagnosticKind"/>,
...
{
    /// <summary>The locator names a file the catalogue does not contain — a
    ...
    /// <summary>The reference names its own file's catalogue key instead of
